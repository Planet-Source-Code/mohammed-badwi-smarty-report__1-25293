...
Begin VB.Form Form1 
   ...
   Caption         =   "Smarty Report - «· ﬁ«—Ì— «·–ﬂÌ… - V1.1"
   ClientHeight    =   3885
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   7320
   ...
   Begin VB.CommandButton Command1 
      Caption         =   "Export Report to HTML- ’œÌ— «· ﬁ—Ì— ﬂ’›Õ… ÊÌ» "
      Height          =   630
      Index           =   1
      Left            =   795
      TabIndex        =   4
   ...
   Begin VB.Label Label1 
      Alignment       =   2  'Center
      Caption         =   "Â–« „À«· ⁄·Ï «” Œœ«„ «œ«… «· ﬁ«—Ì— «·–ﬂÌ… ÊÌÃ» «‰  ﬁÊ„ » ”ÃÌ· «·«œ«… »„Ã—œ «—”«· —”«·… ›«—€… «·Ï «·⁄‰Ê«‰ «·»—ÌœÌ «·„Ê÷Õ «œ‰«Â"
      Height          =   525
      Left            =   690
      TabIndex        =   1
      Top             =   105
...
Dim AppPath As String
    ...
    With SmartyReport1
        ...
        .PageSubject = "Example„À«·"
        .PageHeader = "just Try „Ã—œ  Ã—»…"
        .PageFooter = ""
        Select Case Index
            Case 0
                .ViewReport
